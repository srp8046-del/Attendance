...
.finaltable th.agent,.finaltable td.agent{position:sticky;left:0;text-align:left;min-width:270px}.finaltable th.agent{z-index:3}.finaltable td.agent{z-index:1;background:#fff}.agent-name{font-weight:850;font-size:13px}.agent-ids{display:block;margin-top:4px;color:#7b8492;font-size:10px;font-weight:650}
...
print('Final attendance orientation patch written:', len(s))
