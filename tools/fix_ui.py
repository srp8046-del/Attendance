...
# Remove every duplicate theme bootstrap previously appended.
...
# One authoritative gold/white + full dark theme. Logo dimensions are explicit so the remote logo
# cannot stretch to its natural image size inside the sidebar/login card.
css = r'''
/* LEEWAY_FINAL_UI */
...
print('Unified UI patch written:', len(s))
